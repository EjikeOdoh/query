...
export async function downloader(dto: DownloadDto) {
    const response = await client.get(`/grades/all-progress?year=${dto.year}&school=${dto.school}`, {
        responseType: 'blob',
    });
    ...
    a.href = url;
    a.download = `${dto.year}_Progress_Report_For_${dto.school}.xlsx`;
    a.click();
};