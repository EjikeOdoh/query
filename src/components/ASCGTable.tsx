...
export default function ASCGStudentTable<TData>({ data, remove, source, query, filter }: StudentTableProps<TData>) {
      ...
      <TableBody >
        {data.map((student: TData) => (
          <TableRow key={(student as any).id}>
            ...
            <TableCell className="text-[#171717] text-sm font-light">{(student as any).school}</TableCell>
